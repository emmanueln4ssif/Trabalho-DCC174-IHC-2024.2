          ...
          <View style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
              ...
              <TouchableOpacity style={styles.button}>
                ...
                <Link href="/cadastroFamilias" style={styles.buttonText}>Famílias</Link>
              </TouchableOpacity>
              ...
              <TouchableWithoutFeedback onPress={toggleModal}>
                <View style={styles.overlay2}>
                  <View style={styles.modalContent}>
                    <Text style={styles.modalText}>Nova Família</Text>
                    <Text style={styles.modalText}>Novo Doador</Text>
                    <Text style={styles.modalText}>Nova Campanha</Text>
                  </View>
                </View>
